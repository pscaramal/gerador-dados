...
export default async function insereUnicaNulosIndex(quantidade){
...
async function insereCpf(client){
    ...
    const sql = "insert into risk_blacklist_unica_nulos_index (cpf) values ($1)";
...
async function insereEmail(client){
    ...
    const sql = "insert into risk_blacklist_unica_nulos_index (email) values ($1)";
...
async function insereTelefone(client){
    ...
    const sql = "insert into risk_blacklist_unica_nulos_index (telefone) values ($1)";
...
async function insereMobileId(client){
    ...
    const sql = "insert into risk_blacklist_unica_nulos_index (mobile_id) values ($1)";
